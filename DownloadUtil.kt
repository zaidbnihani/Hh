...
//            addOption("--compat-options", "no-youtube-unavailable-videos")
        ...
        JsRuntimeUtil.logCommand(request.buildCommand())
    ...
    data class DownloadPreferences(
        ...
        val cookies: Boolean = COOKIES.getBoolean(true),
        ...
        val convertAudio: Boolean = AUDIO_CONVERT.getBoolean(true),
        val formatSorting: Boolean = FORMAT_SORTING.getBoolean(),
        val sortingFields: String = SORTING_FIELDS.getString(),
        val audioConvertFormat: Int = PreferenceUtil.getAudioConvertFormat().run { if (this == NOT_SPECIFIED) CONVERT_MP3 else this },
        val videoFormat: Int = PreferenceUtil.getVideoFormat().run { if (this == NOT_SPECIFIED) FORMAT_COMPATIBILITY else this },
